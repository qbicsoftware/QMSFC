...
#### bone marrow ####
load("../recount2_tcga_data_2021-22-04/rse_gene_bone_marrow.Rdata")
...
rse_gene <- rse_gene[, m1$gdc_cases.samples.sample_type == "Primary Blood Derived Cancer - Peripheral Blood" | m1$gdc_cases.samples.sample_type == "Solid Tissue Normal"]
m1 <- m1[m1$gdc_cases.samples.sample_type == "Primary Blood Derived Cancer - Peripheral Blood" | m1$gdc_cases.samples.sample_type == "Solid Tissue Normal",]
## Primary Tumor
sum(m1$gdc_cases.samples.sample_type == "Primary Blood Derived Cancer - Peripheral Blood") # 126
## Solid Tissue Normal
...
#### lymph nodes ####
load("../recount2_tcga_data_2021-22-04/rse_gene_lymph_nodes.Rdata")
dim(colData(rse_gene))
head(assay(rse_gene))
